            ...
            <div className="max-w-md w-full bg-white dark:bg-slate-900 p-10 rounded-3xl shadow-[0_20px_50px_rgba(8,_112,_184,_0.07)] border border-slate-100 dark:border-slate-800/80 transition-all duration-300 hover:shadow-[0_20px_50px_rgba(99,_102,_241,_0.15)]">
                ...
                <div className="text-center mb-9">
                    ...
                    <p className="text-sm text-slate-500 dark:text-slate-400 font-medium">
                        Log in to access your dashboard and booked sessions
                    </p>
                </div>
                ...
                <button type="button" onClick={handleGoogleLogin} className="btn btn-outline w-full flex items-center justify-center gap-3 rounded-2xl border border-slate-200 dark:border-slate-800 bg-white dark:bg-slate-800 hover:bg-slate-50 dark:hover:bg-slate-750 text-slate-700 dark:text-slate-200 font-bold text-sm shadow-sm transition-all duration-300 cursor-pointer">
